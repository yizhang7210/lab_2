...
```{r, echo=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Scale-Location plot for Model One', fig.pos='!h' fig.align="center"}
...
```{r nde, echo=FALSE, fig.pos='!h', fig.height=2, message=FALSE, warning=FALSE, fig.cap='Histogram of residuals for model one and qq-plot for model one', fig.pos='!h' fig.align="center"}
par(mfrow = c(1, 2))
