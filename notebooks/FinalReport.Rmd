...
restricting mobility, in particular to the workplace, in controlling the spread
of Covid-19.
...
```
How much did restricting mobility to the workplace help in controlling the spread of COVID?
```
...
for the worksapce mobility score, specifically the workplace mobility score.
...
mobility alone as the causal factor is misleading. Therefore, we feel that the
population density per sq. mile should be a mandatory variable for all the models.
...
For more advanced models, we propose to use more variables as control, for example,
whether the "Stay at Home" order is in effect, whether the face mask policy is
in effect.
