...
Here we have a significant p-value with the residential mobility score. So it seems
that one point increase in the residential mobility score leads to, on average,
almost 96 more Covid-19 cases per 100,000 inhabitants.
...
The histogram does not show a significant deviation from a normal distribution and
