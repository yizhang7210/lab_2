...
since 2020-02-15 up until2020-07-15, when the mask wearing survey[5]
was taken.
And the independent variable will be the **average** residential mobility score
of the state in the time period.
...
including to workplaces, transit, parks, grocery & pharmacy.
...
hist(data$mask_prob, main='Probability of Mask Wearing', xlab = "mask_prob")
...
hist(log(data$mask_prob), main='Probability of Mask Wearing', xlab = "log(mask_problog)")
