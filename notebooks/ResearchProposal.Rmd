...
A feasibility study of the research question using the COVID data set is conducted. 
Our initial data analysis proves the dataset to be sufficient to answer the 
research question. Evidence of the exploration is presented below. 
...
# Load the package
library(lubridate)
mr <- read.csv("/Users/anusatheesh/Documents/GitHub/lab_2_yi/data/raw/2020_US_Region_Mobility_Report.csv")
case_data <- read.csv("/Users/anusatheesh/Documents/GitHub/lab_2_yi/data/supplement/all-states-history.csv")
